...
import './App.css';
import { steps, edges as edgeConnections, notes, positions, phaseColors } from './flowConfig';
import type { Phase } from './flowConfig';
...
function createNode(step: typeof steps[0], visible: boolean, position?: { x: number; y: number }): Node {
  return {
    id: step.id,
    type: 'custom',
    ...
    <div className="app-container">
      ...
      <div className="controls">
        ...
        <span className="step-counter">
          Step {visibleCount} of {steps.length}
        </span>
        <button onClick={handleNext} disabled={visibleCount >= steps.length}>
          Next
        </button>
