 ...
 *
 * Populates Katalyst with sample data to showcase the app's features.
...
const agents = {
  agents: [
    ...
    },
    {
      ...
      instructions: "You are acting as a Business Analyst and Strategist advising a solo software entrepreneur.\n\nBefore starting:\n1. Read katalyst/data/ai-context.md for a quick snapshot of current state\n2. Read katalyst/data/projects.json to understand current projects\n3. Read katalyst/data/goals.json to understand priorities",
...
const skillsLibrary = {
  skills: [
    ...
    },
    {
      ...
      description: "Manages tasks in Katalyst via JSON data files",
      content: "# Task Management\n\nAll data lives in katalyst/data/ as JSON files.\n\n## Quick Reference\n- AI Context: katalyst/data/ai-context.md (read FIRST)\n- Tasks: katalyst/data/tasks.json\n- Goals: katalyst/data/goals.json\n- Projects: katalyst/data/projects.json\n\n## Creating a Task\nRequired: id, title, description, importance, urgency, kanban, assignedTo\nGenerate IDs as: task_{Date.now()}\n\n## After Any Data Modification\nRun pnpm gen:context in katalyst/ to regenerate ai-context.md",
...
const brainDump = {
  entries: [
    ...
    {
      id: "bd_demo_3",
      content: "Add dark mode toggle to the landing page \u2014 match the Katalyst vibe.",
  ...
  missions: [
    {
      ...
      description: "Your first Field Ops mission. These are pre-loaded posts about Katalyst — yes, we know. Edit them, rewrite them, or use them as-is. The point is to walk through the workflow: approve a task, connect a service, hit execute. If you happen to tell someone about Katalyst along the way... we won't complain.",
      status: "active",
  ...
  tasks: [
    {
      ...
      description: "A short post about discovering Katalyst. Edit the text to match your voice before approving.",
      type: "social-post",
      serviceId: "twitter",
      assignedTo: null,
      status: "pending-approval",
      approvalRequired: true,
      payload: { operation: "create-post", text: "found an open-source tool that gives my AI agents actual structure — task queues, inboxes, reporting. been running Claude Code agents through it and I can finally see what they're all doing.", media: [] },
      result: {},
      attachments: [],
      linkedTaskId: null,
      blockedBy: [],
    ...
    },
    {
      ...
      description: "A post about the core problem Katalyst solves. Rewrite in your voice or skip it.",
      type: "social-post",
      serviceId: "twitter",
      assignedTo: null,
      status: "draft",
      approvalRequired: true,
      payload: { operation: "create-post", text: "the problem with AI agent swarms isn't that they're slow. it's that you have no idea what they're doing. Katalyst gives you visibility without killing their autonomy. been the missing piece for me.", media: [] },
      result: {},
      attachments: [],
      linkedTaskId: null,
      blockedBy: [],
    ...
    },
    {
      ...
      description: "A casual follow-up post. Works best after you've used Katalyst for a bit — edit with your real experience.",
      type: "social-post",
      serviceId: "twitter",
      assignedTo: null,
      status: "draft",
      approvalRequired: true,
      payload: { operation: "create-post", text: "the part where AI agents report back to your inbox with what they actually did? that's the feature I didn't know I needed.", media: [] },
      result: {},
      attachments: [],
      linkedTaskId: null,
      blockedBy: [],
